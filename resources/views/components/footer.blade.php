<footer class="bg-[#FDFDFC] border-t border-gray-200 text-gray-700 mt-12">
    ...
    <div class="container mx-auto px-6 py-12  gap-10"> 
        ...
        <div class="mt-12">
            ...
            <div class="flex gap-4 justify-end">
                <a href="https://github.com/PrimaSentana/myUmabali" target="_blank" class="text-gray-600 hover:text-gray-900 transition">
                ...
                <a href="https://www.instagram.com/primasentana_/" target="_blank" class="text-gray-600 hover:text-gray-900 transition">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" class="w-5 h-5">
    ...
    <div class="border-t border-gray-200 py-4 text-center text-sm text-gray-500">
        © 2026 Umabali. All rights reserved.
    </div>
</footer>
